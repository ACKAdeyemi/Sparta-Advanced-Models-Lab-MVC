...
class ParagraphsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paragraph" do
    assert_difference('Paragraph.count') do
      post paragraphs_url, params: { paragraph: { chapter_id: @paragraph.chapter_id, lorem: @paragraph.lorem } }
    end
  ...
  test "should update paragraph" do
    patch paragraph_url(@paragraph), params: { paragraph: { chapter_id: @paragraph.chapter_id, lorem: @paragraph.lorem } }
